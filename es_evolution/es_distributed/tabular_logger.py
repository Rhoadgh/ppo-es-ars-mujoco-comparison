...
# Compatibility bridge for TF 2.x
tf1 = tf.compat.v1
tf1.disable_v2_behavior()

# Import the core event protocol
...
class TbWriter(object):
    def __init__(self, dir, prefix):
        self.dir = dir
        self.step = 1
        # Using the stable TF1 file writer instead of the old pywrap_tensorflow
        self.evwriter = tf1.summary.FileWriter(dir)

    def write_values(self, key2val):
        # Create a Summary object
        summary = tf1.Summary(value=[
            tf1.Summary.Value(tag=k, simple_value=float(v))
        ...
        # Use the modern 'add_event' method
        self.evwriter.add_event(event)
        self.evwriter.flush()
        self.step += 1
